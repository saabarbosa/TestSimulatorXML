<%@ Page Language="C#" MasterPageFile="~/Private/Administrator/MasterAdmin.master" AutoEventWireup="true" CodeFile="DelUser.aspx.cs" Inherits="Private_Administrator_DelUser" Title="" %>
        ...
        <tr>
            <td>
                <asp:Label ID="lblConfirmacao" runat="server" 
                    Text="Tem certeza que deseja excluir o Usuário abaixo?"></asp:Label></td>
        </tr>
    </table>
    <table style="margin-left: 20px; width: 95%; margin-right: 20px; height: 30px">
        <tr>
    ...
    <table style="margin-left: 20px; width: 95%; margin-right: 20px; height: 30px">
        <tr>
            <td>
                ...
                &nbsp;<asp:Label ID="lblSucesso" runat="server" ForeColor="Green" Text="Usuário excluído com sucesso."
